...
cp "dist/chaoxing-macos-arm64.bin" "${MACOS_DIR}/chaoxing-macos-arm64.bin"
chmod +x "${MACOS_DIR}/chaoxing-macos-arm64.bin"
cp "dist/chaoxing-macos-x64.bin" "${MACOS_DIR}/chaoxing-macos-x64.bin"
chmod +x "${MACOS_DIR}/chaoxing-macos-x64.bin"
cp "package.json" "${MACOS_DIR}/package.json"
mkdir -p "${MACOS_DIR}/apps/server"
mkdir -p "${MACOS_DIR}/apps/web"
cp -R "apps/server/build" "${MACOS_DIR}/apps/server/build"
cp -R "apps/server/node_modules" "${MACOS_DIR}/apps/server/node_modules"
cp -R "apps/web/dist" "${MACOS_DIR}/apps/web/dist"
